...
def helper():
        ...
        print("------------")
        print("\t.--skip dmitry --skip theHarvester: Skip the 'dmitry' and 'theHarvester' tests.")
        print("\t --nospinner: Disable the idle loader/spinner.")
        print("\t--update   : Updates the scanner to the latest version.")
        print("\t --help     : Displays this help context.")
...
if args_namespace.help or (not args_namespace.update \
    ...
    if len(unavail_tools_names) == 0:
        ...
        print("\t"+bcolors.WARNING+"Some of these tools "+bcolors.BADFAIL+str(unavail_tools_names)+bcolors.ENDC+bcolors.WARNING+" are unavailable or will be skipped. RapidScan will still perform the rest of the tests. Install these tools to fully utilize the functionality of VulnScan."+bcolors.ENDC)
